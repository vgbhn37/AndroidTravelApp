...
public class AttractionFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        drawables.add(res.getDrawable(R.drawable.attr1,null));
        drawables.add(res.getDrawable(R.drawable.restaurant1, null ));
        drawables.add(res.getDrawable(R.drawable.hotel1,null));
        drawables.add(res.getDrawable(R.drawable.attr2,null));
        drawables.add(res.getDrawable(R.drawable.restaurant2,null));
        drawables.add(res.getDrawable(R.drawable.hotel2,null));
    ...
    private void startLocationService() {
        ...
        Toast.makeText(getContext(), "근처 10km 이내 관광지를 찾고있어요.\n10초 정도의 시간이 소요될 수 있어요.", Toast.LENGTH_LONG).show();
    ...
    // 현재 위치를 기반으로 리싸이클러 뷰에 표시할 반경 10km 이내의 관광지 정보 가져오기 (한국관광공사 api)
    ...
    private class LoadingThread extends Thread {
        ...
        public void run() {
            ...
            for(int i = 0; i<15; i++){
                final Drawable drawable = drawables.get(i%6);
                handler.post(new Runnable() {
                    @Override
                    public void run() {
